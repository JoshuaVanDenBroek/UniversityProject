This is the code for my university project. 
...
The Decryption application will not work unless you create a google console account, enable google vision api, and obtain a API key json file and rename it to PERMISSION.json
